...
public class CheatBlockerLanguageMap {
    ...
    CheatBlockerLanguageMap(String locale) {
        InputStream inputstream = CheatBlockerLanguageMap.class.getResourceAsStream("/assets/cheatblocker/lang/" + locale + ".lang");
    ...
    private static void inject(CheatBlockerLanguageMap inst, InputStream inputstream) {
    ...
    static CheatBlockerLanguageMap getInstance() {
        return instance;
    }
